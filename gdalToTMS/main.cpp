...
int main(int argc, const char* argv[]) {
	...
	u_TMS.f_Basic.Input = "E:\\data\\tif\\地形\\dem演示\\白模地形最终.tif";
	std::string output = "E:\\out\\tif\\地形1" /*+ io_constant::getGuid8()*/;
	u_TMS.f_Basic.Output = output.c_str();
	u_TMS.f_Basic.RunnableThread = 8;//开启8线程
	u_TMS.f_Basic.OverlayFile = 0;

	u_TMS.f_TMSConfig.TMSFormat = "mesh"; /*"terrain mesh png jpg tiff*/
	u_TMS.f_TMSConfig.Profile = "geodetic";/*mercator geodetic*/
