#ifndef GBOUTPUTSTREAM_HPP
#define GBOUTPUTSTREAM_HPP
...
namespace gb {
  class GBOutputStream;
}

/// This represents a generic GB_DLL output stream to write raw data
class GB_DLL gb::GBOutputStream {
public:
