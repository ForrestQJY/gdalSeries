...
public:
  ...
  setBounds(T minx, T miny, T maxx, T maxy) {
    if (minx > maxx) {
      throw GBException("The minimum X value is greater than the maximum X value");
    } else if (miny > maxy) {
      throw GBException("The minimum Y value is greater than the maximum Y value");
    }
  ...
  setMinX(T newValue) {
    if (newValue > getMaxX())
      throw GBException("The value is greater than the maximum X value");
  ...
  setMinY(T newValue) {
    if (newValue > getMaxY())
      throw GBException("The value is greater than the maximum Y value");
  ...
  setMaxX(T newValue) {
    if (newValue < getMinX())
      throw GBException("The value is less than the minimum X value");
  ...
  setMaxY(T newValue) {
    if (newValue < getMinY())
      throw GBException("The value is less than the minimum Y value");
