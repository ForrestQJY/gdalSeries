...
class GB_DLL gb::GDALSerializer {
public:
  ...
  virtual bool mustSerializeCoordinate(const gb::TileCoordinate *coordinate) = 0;

  /// Serialize a GDALTile to the store
  virtual bool serializeTile(const gb::GDALTile *tile, GDALDriver *driver, const char *extension, CPLStringList &creationOptions) = 0;
