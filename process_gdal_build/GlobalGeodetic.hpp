 ...
 */
class GB_DLL gb::GlobalGeodetic : public Grid {
public:
	/// Initialise the profile with a specific tile size
	GlobalGeodetic(i_tile tileSize = TILE_SIZE, bool tmsCompatible = true) : Grid(tileSize, CRSBounds(-180, -90, 180, 90), cSRS, (tmsCompatible) ? 2 : 1)
	{

	}
	GlobalGeodetic(OGRSpatialReference srs, i_tile tileSize = TILE_SIZE, bool tmsCompatible = true) : Grid(tileSize, CRSBounds(-180, -90, 180, 90), srs, (tmsCompatible) ? 2 : 1)
	{
