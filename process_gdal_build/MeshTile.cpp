...
template <typename T> int writeEdgeIndices(GBOutputStream& ostream, const Mesh& mesh, double edgeCoord, int componentIndex) {
 ...
 */
void
MeshTile::writeFile(GBOutputStream& ostream, bool writeVertexNormals) const {
