 ...
 */
class GB_DLL gb::GlobalMercator :
	public Grid {
public:

	GlobalMercator(i_tile tileSize = 256) : Grid(tileSize, CRSBounds(-cOriginShift, -cOriginShift, cOriginShift, cOriginShift), cSRS)
	{
	}
	GlobalMercator(OGRSpatialReference srs, i_tile tileSize = TILE_SIZE) :Grid(tileSize, CRSBounds(-cOriginShift, -cOriginShift, cOriginShift, cOriginShift), srs)
	{
	}
protected:
