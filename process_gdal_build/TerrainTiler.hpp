...
protected:
  ...
  void prepareSettingsOfTile(TerrainTile *tile, const TileCoordinate &coord, float *rasterHeights, gb::i_tile tileSizeX, gb::i_tile tileSizeY) const;
};
